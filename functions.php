...
add_image_size( 'bones-thumb-334', 334, 235, true );
...
function bones_custom_image_sizes( $sizes ) {
    return array_merge( $sizes, array(
        ...
        'bones-thumb-334' => __('334px by 235px'),
    ) );
}
...
add_filter( 'rwmb_meta_boxes', 'km_register_meta_boxes' );

function km_register_meta_boxes( $meta_boxes )
{
    $prefix = 'km_';
